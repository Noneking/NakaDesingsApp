...
public class CategoryActivity extends Fragment implements TabHost.OnTabChangeListener, TabHost.OnTouchListener {
    ...
    public static CategoryActivity newInstance(String param1, String param2) {
        CategoryActivity fragment = new CategoryActivity();
    ...
    private void initComponents() {
        ...
        tab_category_view= (LinearLayout) this.view.findViewById(R.id.category_view_linearLayout);
        tab_category_insert= (LinearLayout) this.view.findViewById(R.id.category_insert_linearLayout);
    ...
    private void initOperations() {
        ...
        spec.setContent(R.id.category_view_linearLayout);
        spec.setIndicator("View", res.getDrawable(R.drawable.category_128x128));
        tabhost.addTab(spec);

        //Insert Tab
        spec=tabhost.newTabSpec("CATEGORY_INSERT");
        spec.setContent(R.id.category_insert_linearLayout);
